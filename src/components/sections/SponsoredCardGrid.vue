...
export default {
  ...
  created() {
    axios.get("http://127.0.0.1:8000/api/sponsored/gold/4").then((response) => {
      ...
      axios
        .get("http://127.0.0.1:8000/api/sponsored/silver/4")
        .then((response) => {
        ...
        .finally(() => {
          axios
            .get("http://127.0.0.1:8000/api/sponsored/bronze/4")
            .then((response) => {
